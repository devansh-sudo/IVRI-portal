...
export default class Forgotpass extends React.Component {
    ...
    render() {
      ...
      <View
        ...
        <Text style = {{color:'black',textAlign:'center',marginTop:30,fontSize:16,marginHorizontal:40}}>कृपया आप रजिस्टर मोबाइल नंबर दर्ज करें, हम आपको छह अंकों का सत्यापन कोड भेजेंगे</Text>
      <View style = {styles.container}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Verifyotp')}
               ...
               <Text style = {styles.submitButtonText}>OTP भेजें</Text>
            </TouchableOpacity>
         </View>
